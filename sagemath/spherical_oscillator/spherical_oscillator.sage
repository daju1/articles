...
t_zap_data = [ (thetha_i, tzap(t, R0, r0, v0, a0, thetha_i)) for thetha_i in thetas]
...
phi_lw_data = [ (R0_i, phi_lw(-q, t, R0_i, Rneg, 0, 0) + phi_lw(q, t, R0_i, Rpos, 0, 0)) for R0_i  in np.arange(min_R0, max_R0, step_R0) ]
...
a0pos = 0.05
a0neg = -0.15
phi_lw_data = [ (R0_i, phi_lw(-q, t, R0_i, Rneg, v0neg, a0neg) + phi_lw(q, t, R0_i, Rpos, v0pos, a0pos)) for R0_i in np.arange(min_R0, max_R0, step_R0) ]
...
dt = 0.5
t2 = 20.0
phi_lw_data = [ (R0_i, phi_lw(-q, t_i, R0_i, Rneg, v0neg, a0neg) + phi_lw(q, t_i, R0_i, Rpos, v0pos, a0pos)) for R0_i in np.arange(min_R0, max_R0, step_R0) for t_i in np.arange(t1, t2, dt)]
