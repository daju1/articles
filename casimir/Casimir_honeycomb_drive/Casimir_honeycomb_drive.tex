...
\author{A.Yu. Drozdov\,\orcidlink{0009-0004-1386-4534} \\ \\ \textit{V.N. Karazin Kharkiv National University, 61022, Svoboda Sq. 4, Kharkiv, Ukraine} \\ \textit{E-mail: \href{mailto:me@somewhere.com}{me@somewhere.com}} \\ \\ Received on April 17, 2023. Reviewed on May 10, 2023. \\
Accepted for publication on May 22, 2023. \\ \\ }
    ...
    % Document parameters
    % Document title
    \title{\textbf{Casimir honeycomb drive: on the force on perfectly conducting honeycomb on a plate.}}
    \date{} % clear date
...
tmargin=2.51cm,bmargin=3cm,lmargin=2cm,rmargin=2cm}
...
%\fancyhead[RO,LE]{Casimir honeycomb drive: on the force on perfectly conducting honeycomb on a plate.}
\fancyhead[CE]{{\it Casimir honeycomb drive: on the force on perfectly conducting honeycomb on a plate.}}
\fancyhead[CO]{A.Yu. Drozdov}
% \fancyhead[E]{Casimir honeycomb drive: on the force on perfectly conducting honeycomb on a plate.}% This triggers a warning!

\renewcommand{\headrulewidth}{0pt} % remove the top horizontal rule

\fancyfoot{} % clear all footer fields
\fancyfoot[LE,RO]{\thepage}
\fancyfoot[LO,RE]{The Journal of V.N. Karazin Kharkiv National University. Series “Physics” Iss. 38, 2023\\Вісник ХНУ імені В.Н. Каразіна, серія «Фізика», вип. 38, 2023}
\fancyfoot[CO,CE]{}
...
% \textit{Харківський національний університет імені В.Н. Каразіна, 61022, майдан Свободи. 4, Харків, Україна}
\vspace{3.5mm}
%    \begin{abstract}
...
\caption{}{\centering{\textbf{Fig.3.} Antipin's angle}}
\end{center}
\label{fig:Antipins_angle}
\end{figure}
