...
\end{matrix}\] Далее векторное произведение радиус-вектора на ротор
...
и если учесть что \[\frac{\partial R}{\partial x}=\frac{{{R}_{x}}}{K}\]
то можно записать
...
\end{align}\] Интересно, что этот градиент можно также найти значительно
