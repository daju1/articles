...
\[\overrightarrow{E}=-\frac{\mu }{c}\frac{\partial {{\overrightarrow{A}}_{H}}}{\partial t}-grad\ \varphi \],
то
${{div}_{\emph{q}}\overrightarrow{D}={{div}}_{q}} \varepsilon \overrightarrow{E}=-\frac{\mu \varepsilon }{c}\frac{\partial }{\partial t}{{div}_{\emph{q}}\overrightarrow{{{A}_{H}}}-{{div}}_{q}} grad \varphi$
...
получаем:
${{div}_{\emph{q}}~\overrightarrow{D}=-\frac{\mu \varepsilon }{c}\frac{\partial }{\partial t}{{div}}_{q}}\overrightarrow{{{A}_{H}}}+4\pi \rho$
