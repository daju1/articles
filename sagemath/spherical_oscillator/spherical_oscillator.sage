...
t_zap_data = [ (thetha_i, tzap(t, R0, r0, v0, a0, thetha_i, r_min)) for thetha_i in thetas]
...
a0pos = 0.05
a0neg = -0.15
phi_lw_data = [ (R0_i, phi_lw(-q, t, R0_i, Rneg, v0neg, a0neg, r_min) + phi_lw(q, t, R0_i, Rpos, v0pos, a0pos, r_min)) for R0_i in np.arange(min_R0, max_R0, step_R0) ]
