...
\def\myacceptedukr{Прийнято до друку on 18 червня 2024 р.}
...
% \end{multicols}
    ...
    \section*{\centering{\uppercase{A way \\ of calculating~}\(\delta\left(E/V\right)\)}}\label{a-way-of-calculating-deltaleftevright}

%    \section*{\centering{\(\delta\left(E/V\right)\) \uppercase{calculating way}}}\label{a-way-of-calculating-deltaleftevright}
...
% \end{multicols}
    ...
    \section*{\centering{\uppercase{How} \(\delta\left(E/V\right)\) \\ \uppercase{depends on} \(a k_m\) ?}}\label{how-deltaleftevright-depends-on-a-k_m}
\vspace{-3.5mm}
...
\begin{center}
\begin{tabular}{ r }
Table 1. The result of calculating the expression (\ref{eq:12}).
\end{tabular}
...
У класичному одновимірному двотіловому ефекті Казимира між двома пластинами виникає сила Казимира
виникає між двома пластинами як різниця електромагнітних тисків
нульового квантово-вакуумного коливання по різні боки кожної з пластин.
Пластини штовхаються одна до одної зовнішніми полями квантово-вакуумних коливань,
які в класичній конфігурації перевищують внутрішні поля квантово-вакуумних коливань.
Можна спробувати створити різницю електромагнітних тисків
квантово-вакуумних коливань по різні боки однієї пластини
...
В результаті було виявлено, що формула для сили на одиницю і для густини енергії на одиницю площі
на одиницю площі дуже схожа на формулу класичного ефекту Казимира,
