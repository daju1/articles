...
Настоящая работа представляет собой объединённое издание серии исследований, посвящённых критическому переосмыслению фундаментальных положений классической электродинамики. В работу включены оригинальные тексты статей автора (2019--2025) с минимальными редакционными правками, дополненные связующим анализом и новыми результатами, касающимися связи продольной магнитной проницаемости $\mu_{\parallel}$ с вариационным принципом Ферми.
...
\subsection*{А.Ю. Дроздов, 26 февраля 2019 г.}
...
\subsection*{А.Ю. Дроздов, 27 февраля 2019 г.}
...
\subsection*{А.Ю. Дроздов, 17 мая 2019 г.}
...
\subsection*{А.Ю. Дроздов, 4-5..27 февраля 2019 г.}
...
% \begin{enumerate}
Магнитная проницаемость $\mu_{\parallel}$ - это фундаментальное свойство среды (вакуума), а поправка Ферми - это поправка к \textbf{мере интегрирования} интеграла действия мировых трубок ускоряющихся зарядов.%, а не функция динамической переменной.
%     \item Если бы $\mu_{\parallel}$ зависела от ускорения, волновое уравнение стало бы нелинейным и непредсказуемым.
% , а не к свойствам вакуума.
% \end{enumerate}
...
\begin{equation}
\mu_{\parallel} = \mu \cdot \chi_{\text{vac}}
\label{eq:mu_correct}
\end{equation}
...
Дроздов А.Ю. Соответствуют ли уравнения для запаздывающих потенциалов калибровке Лоренца? 17 марта 2020.
