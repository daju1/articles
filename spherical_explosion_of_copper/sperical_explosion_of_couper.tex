...
\begin{wrapfigure}{l}{0.6\textwidth}
    \centering
    \includegraphics[scale=0.35]{spherical_capascitor_phi_Rneg=2_Rpos=1}
...
\begin{wrapfigure}{l}{0.6\textwidth}
    \centering
    \includegraphics[scale=0.35]{spherical_oscillator_phi_Rneg=2_Rpos= 1_v0neg=1_v0pos=0.5_a0neg=0_a0pos=0c=3_t=0}
    \caption{Скалярный потенциал сферического осциллятора}
