...
// E1
// Градиентное электрическое поле ${E}_{1}$ можно разложить
// на чисто кулоновское слагаемое ${E}_{1q}$
// и слагаемое зависящее от ускорения ${E}_{1a}$
// ${E}_{1} = {E}_{1q} + {E}_{1a}$
...
static inline cubareal Iq (cubareal r0, cubareal q, cubareal theta_a, cubareal ra, cubareal phi_q, cubareal theta_q, cubareal rq )
{
    ...
    return za_minus_zq * rho_q(r0, q) * Sq(rq) * sin(theta_q) / Cb(R);
}
