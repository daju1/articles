...
```
    ...
    /usr3/articles/sagemath_docker_build/sage/local/lib/python3.10/site-packages/sage/plot/contour_plot.py:202: UserWarning: No contour levels were found within the data range.
...
![png](output_164_6.png)
    



    
![png](output_164_7.png)
    



    
![png](output_164_8.png)
    



    
![png](output_164_9.png)
    



    
![png](output_164_10.png)
    



    
![png](output_164_11.png)
    



    
![png](output_164_12.png)
...
$\displaystyle \frac{7 \, \sqrt{30} \sqrt{6} \sqrt{5} \pi^{2} \cos\left(\theta_{m}\right) \sin\left(\theta_{m}\right)}{4096 \, r_{m}}$
...
$\displaystyle -\frac{189 \, \sqrt{5} \pi^{2} {\left(7 \, \sqrt{5} \cos\left(\theta_{m}\right) \sin\left(\theta_{m}\right)^{2} - 4 \, \sqrt{5} \cos\left(\theta_{m}\right)\right)} \sin\left(\theta_{m}\right)}{65536 \, r_{m}}$
...
$\displaystyle \frac{1677 \, \sqrt{13} \pi^{2} {\left(33 \, \sqrt{13} \cos\left(\theta_{m}\right)^{5} - 30 \, \sqrt{13} \cos\left(\theta_{m}\right)^{3} + 5 \, \sqrt{13} \cos\left(\theta_{m}\right)\right)} \sqrt{-\cos\left(\theta_{m}\right)^{2} + 1}}{4194304 \, r_{m}}$
...
$\displaystyle \frac{11887 \, \sqrt{17} \pi^{2} {\left(715 \, \sqrt{17} \cos\left(\theta_{m}\right)^{7} - 1001 \, \sqrt{17} \cos\left(\theta_{m}\right)^{5} + 385 \, \sqrt{17} \cos\left(\theta_{m}\right)^{3} - 35 \, \sqrt{17} \cos\left(\theta_{m}\right)\right)} \sqrt{-\cos\left(\theta_{m}\right)^{2} + 1}}{536870912 \, r_{m}}$
...
$\displaystyle \frac{44537 \, \sqrt{21} \pi^{2} {\left(4199 \, \sqrt{21} \cos\left(\theta_{m}\right) \sin\left(\theta_{m}\right)^{8} - 8840 \, \sqrt{21} \cos\left(\theta_{m}\right) \sin\left(\theta_{m}\right)^{6} + 6240 \, \sqrt{21} \cos\left(\theta_{m}\right) \sin\left(\theta_{m}\right)^{4} - 1664 \, \sqrt{21} \cos\left(\theta_{m}\right) \sin\left(\theta_{m}\right)^{2} + 128 \, \sqrt{21} \cos\left(\theta_{m}\right)\right)} \sin\left(\theta_{m}\right)}{8589934592 \, r_{m}}$
...
$\displaystyle \frac{6}{11} \, \pi \cos\left(\theta_{m}\right)$
...
$\displaystyle \frac{28}{429} \, \pi {\left(5 \, \cos\left(\theta_{m}\right)^{3} - 3 \, \cos\left(\theta_{m}\right)\right)}$
...
$\displaystyle \frac{4}{975} \, \pi {\left(63 \, \cos\left(\theta_{m}\right)^{5} - 70 \, \cos\left(\theta_{m}\right)^{3} + 15 \, \cos\left(\theta_{m}\right)\right)}$
...
$\displaystyle \frac{6}{17017} \, \pi {\left(429 \, \cos\left(\theta_{m}\right)^{7} - 693 \, \cos\left(\theta_{m}\right)^{5} + 315 \, \cos\left(\theta_{m}\right)^{3} - 35 \, \cos\left(\theta_{m}\right)\right)}$
...
$\displaystyle \frac{2}{546975} \, \pi {\left(12155 \, \cos\left(\theta_{m}\right)^{9} - 25740 \, \cos\left(\theta_{m}\right)^{7} + 18018 \, \cos\left(\theta_{m}\right)^{5} - 4620 \, \cos\left(\theta_{m}\right)^{3} + 315 \, \cos\left(\theta_{m}\right)\right)}$
...
```
    ...
    /usr3/articles/sagemath_docker_build/sage/local/lib/python3.10/site-packages/sage/plot/contour_plot.py:206: UserWarning: No contour levels were found within the data range.
...
![png](output_193_4.png)
    



    
![png](output_193_5.png)
    



    
![png](output_193_6.png)
    



    
![png](output_193_7.png)
    



    
![png](output_193_8.png)
    



    
![png](output_193_9.png)
    



    
![png](output_193_10.png)
    



    
![png](output_193_11.png)
    



    
![png](output_193_12.png)
...
![png](output_194_3.png)
    



    
![png](output_194_4.png)
    



    
![png](output_194_5.png)
    



    
![png](output_194_6.png)
    



    
![png](output_194_7.png)
    



    
![png](output_194_8.png)
    



    
![png](output_194_9.png)
    



    
![png](output_194_10.png)
    



    
![png](output_194_11.png)
...
```
    ...
    CPU times: user 1.42 s, sys: 7 µs, total: 1.42 s
    Wall time: 1.42 s
...
def plot_make_U(l, show=False):
    ...
    #p.show(title="z * Потенциальная функция взаимодействия прецессирующих магнитных диполей l =" + str(l),
    #       axes_labels=["Расстояние между частицами zс", ""])

    #p = list_plot(plot_data_sum_Uzc2)
    #p.show(title="z^2 * Потенциальная функция взаимодействия прецессирующих магнитных диполей l =" + str(l),
    #       axes_labels=["Расстояние между частицами zс", ""])

    #p = list_plot(plot_data_sum_Uzc3)
    #p.show(title="z^3 * Потенциальная функция взаимодействия прецессирующих магнитных диполей l =" + str(l),
    #       axes_labels=["Расстояние между частицами zс", ""])

    
    #p = list_plot(plot_data_sum_W)
    #p.show(title="Энергия взаимодействия магнитных диполей l =" + str(l),
    #       axes_labels=["Расстояние между частицами zс", ""])

    #p = list_plot(plot_data_sum_Wzc1)
    #p.show(title="z * Энергия взаимодействия магнитных диполей l =" + str(l),
    #       axes_labels=["Расстояние между частицами zс", ""])

    #p = list_plot(plot_data_sum_Wzc2)
    #p.show(title="z^2 * Энергия взаимодействия магнитных диполей l =" + str(l),
    #       axes_labels=["Расстояние между частицами zс", ""])

    #p = list_plot(plot_data_sum_Wzc3)
    #p.show(title="z^3 * Энергия взаимодействия магнитных диполей l =" + str(l),
    #       axes_labels=["Расстояние между частицами zс", ""])
...
![png](output_224_3.png)
    



    
![png](output_224_4.png)
    



    
![png](output_224_5.png)
    



    
![png](output_224_6.png)
    



    
![png](output_224_7.png)
    



    
![png](output_224_8.png)
    



    
![png](output_224_9.png)
    



    
![png](output_224_10.png)
    


    list index out of range
    Rho =  0.0 Z = -40.0 z_c = 6
    list index out of range
    Rho =  0.0 Z = -40.0 z_c = 8
    list index out of range
    Rho =  0.0 Z = -40.0 z_c = 10
    list index out of range
    Rho =  0.0 Z = -40.0 z_c = 12
    list index out of range
    Rho =  0.0 Z = -40.0 z_c = 14
    list index out of range
    Rho =  0.0 Z = -40.0 z_c = 16
    list index out of range
    Rho =  0.0 Z = -40.0 z_c = 18
    list index out of range
    Rho =  0.0 Z = -40.0 z_c = 20
    list index out of range
    Rho =  0.0 Z = -40.0 z_c = 22
    list index out of range
    Rho =  0.0 Z = -40.0 z_c = 24
    list index out of range
    Rho =  0.0 Z = -40.0 z_c = 26
    list index out of range
    Rho =  0.0 Z = -40.0 z_c = 28
    list index out of range
    Rho =  0.0 Z = -40.0 z_c = 30
    list index out of range
    Rho =  0.0 Z = -40.0 z_c = 32
    list index out of range
    Rho =  0.0 Z = -40.0 z_c = 34
    list index out of range
    Rho =  0.0 Z = -40.0 z_c = 36
    list index out of range
    Rho =  0.0 Z = -40.0 z_c = 38
    list index out of range
    Rho =  0.0 Z = -40.0 z_c = 40



    
![png](output_224_12.png)
...
Таким образом на данных графиках просматривается вывод: мне пока не удалось доказать желаемый результат  о том что Потенциальная функция взаимодействия прецессирующих магнитных диполей убывает по закону $\frac{1}{z}$ что соответствовало бы классическому кулоновскому взаимодействию электрических зарядов.

Мне хотелось в данной модели показать что "электрический заряд" становится кажущимся эффективным фантомом, который является лишь следствием проявления магнитной силы Ампера между движущимися магнитными зарядами образующими магнитные токи.
...
```python
U_int_z = lambda l, z_c, rho, z1, z2: \
    scipy_integrate.quad(lambda z : U_12_integrand(l, rho, z, z_c), z1, z2)[0]
```


```python
W_int_z = lambda l, z_c, rho, z1, z2: \
    scipy_integrate.quad(lambda z : W_12_integrand(l, rho, z, z_c), z1, z2)[0]
```


```python
U_int_z_int_rho = lambda l, z_c, z1, z2, rho1, rho2: \
    scipy_integrate.quad(lambda rho : U_int_z(l, z_c, rho, z1, z2), rho1, rho2)[0]
```


```python
W_int_z_int_rho = lambda l, z_c, z1, z2, rho1, rho2: \
    scipy_integrate.quad(lambda rho : W_int_z(l, z_c, rho, z1, z2), rho1, rho2)[0]
```
