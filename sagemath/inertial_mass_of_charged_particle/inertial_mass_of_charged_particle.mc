...
I1    (ra, theta_a, rq, theta_q) := integrate(1/R(ra, theta_a, rq, theta_q, phi_q), phi_q, 0, 2 * %pi);
...
I3(Rq, aq, ra, theta_a) := integrate(rho_q(rq) * rq^2 * I2(ra, theta_a, rq), rq, 0, inf);

I4(Rq, aq, ra, theta_a) := 2 * %pi * I3(Rq, aq, ra, theta_a);
I5(Rq, aq, ra)          := integrate(sin(theta_a) * I4(Rq, aq, ra, theta_a), theta_a, 0, %pi);
I6(Rq, aq)              := integrate(rho_q(ra) * ra^2 * I5(Rq, aq, ra), ra, 0, inf);